...
void double_buffer_init(double_buffer_td *p_buffer, void *buffer_a, void *buffer_b)
{
...
int main()
{
    ...
    double_buffer_init(&test_buffer, buffer_a, buffer_b);
    p_buf_active = test_buffer.active;
